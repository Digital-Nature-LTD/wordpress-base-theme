...
function digital_nature_enqueue_block_editor_assets()
{
	...
	wp_enqueue_script('digital-nature-editor', get_template_directory_uri() . '/public/assets/js/editor/digital-nature-editor.js', ['wp-edit-post'], wp_get_theme()->get('Version'));
}
